...
#define IOCTL_MFC_GET_YUV_BUF_ADDR		(0x00800011)
...
#define IOCTL_MFC_GET_YUV_SIZE			(0x00800112)
...
#define IOCTL_CACHE_FLUSH_B_YUV			(0x00800115)
#define IOCTL_MFC_GET_PHY_B_YUV_BUF_ADDR	(0x00800116)
#define IOCTL_MFC_GET_B_YUV_BUF_ADDR		(0x00800117)
#endif
