...
#ifndef _TLV320AIC23_28_H
#define _TLV320AIC23_28_H

#define CONFIG_HHTECH_MINIPMP	1

#define TLV320AIC23_SYSCLK	0
...
extern struct snd_soc_codec_dai tlv320aic23_dai;
extern struct snd_soc_codec_device soc_codec_dev_tlv320aic23;

#if 1 //lzcx
#define TLV320AIC23_PLL1			0
#define TLV320AIC23_PLL2			1

/* clock inputs */
#define TLV320AIC23_MCLK		0
#define TLV320AIC23_PCMCLK		1

/* clock divider id's */
#define TLV320AIC23_PCMDIV		0
#define TLV320AIC23_BCLKDIV		1
#define TLV320AIC23_VXCLKDIV		2

/* PCM clock dividers */
#define TLV320AIC23_PCM_DIV_1	(0 << 6)
#define TLV320AIC23_PCM_DIV_3	(2 << 6)
#define TLV320AIC23_PCM_DIV_5_5	(3 << 6)
#define TLV320AIC23_PCM_DIV_2	(4 << 6)
#define TLV320AIC23_PCM_DIV_4	(5 << 6)
#define TLV320AIC23_PCM_DIV_6	(6 << 6)
#define TLV320AIC23_PCM_DIV_8	(7 << 6)

/* BCLK clock dividers */
#define TLV320AIC23_BCLK_DIV_1	(0 << 7)
#define TLV320AIC23_BCLK_DIV_2	(1 << 7)
#define TLV320AIC23_BCLK_DIV_4	(2 << 7)
#define TLV320AIC23_BCLK_DIV_8	(3 << 7)

/* VXCLK clock dividers */
#define TLV320AIC23_VXCLK_DIV_1	(0 << 6)
#define TLV320AIC23_VXCLK_DIV_2	(1 << 6)
#define TLV320AIC23_VXCLK_DIV_4	(2 << 6)
#define TLV320AIC23_VXCLK_DIV_8	(3 << 6)
#define TLV320AIC23_VXCLK_DIV_16	(4 << 6)

#define TLV320AIC23_DAI_HIFI		0
#define TLV320AIC23_DAI_VOICE		1


#endif


#endif /* _TLV320AIC23_28H */
