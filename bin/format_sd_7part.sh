...
names=(   "boot"    "rom" "factory" "system" "NOOK"  "cache" "data" )
types=(   "0x0C,*" "0x0C"    "L"       "L"    "0x0C"      "L"   "L"  )
formats=( "vfat"   "vfat"  "ext2"   "ext2" "vfat"   "ext3"   "ext3"  )
# Assuming a 2 GB SD card
sizes=(      38        8      95      144      120    120        ""  )
